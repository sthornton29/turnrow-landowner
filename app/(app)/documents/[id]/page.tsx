...
async function primaryAttachment(
  ...
  const simple: Partial<Record<DocumentEntityType, { table: string; prefix: string; href: string; col?: string }>> = {
    ...
    cemetery: { table: "cemeteries", prefix: "Cemetery", href: "/cemeteries" },
    maintenance_issue: { table: "maintenance_issues", prefix: "Maintenance issue", href: "/maintenance", col: "label" },
